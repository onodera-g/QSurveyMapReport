#!/usr/bin/env python3
"""
Fallback script to create GPS JPEG when direct execution fails.
This creates the file directly using PIL and piexif.
"""
import sys
import os
...
try:
    ...
    print("Please install: pip install Pillow piexif", file=sys.stderr)
    sys.exit(1)
